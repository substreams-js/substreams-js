...
If you want to contribute, but aren't sure where to start, you can create a [new discussion](https://github.com/substreams-js/substreams-js/discussions).
...
```bash
git clone https://github.com/substreams-js/substreams-js.git
```

Or the [GitHub CLI](https://cli.github.com):

```bash
gh repo clone substreams-js/substreams-js
```
