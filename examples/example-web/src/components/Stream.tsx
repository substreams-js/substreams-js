        ...
        switch (message.case) {
          case "data": {
            setState((prev) => {
              ...
              state.messages = messages.length > 0 ? prev.messages.concat(...messages).slice(-LIMIT) : prev.messages;
    ...
    <Card className="mt-7">
      ...
      <ul>
        {state.messages.map((item, index) => (
          // rome-ignore lint/suspicious/noArrayIndexKey: this is just a demo ...
          <li key={index}>
            <pre>{item}</pre>
          </li>
        ))}
