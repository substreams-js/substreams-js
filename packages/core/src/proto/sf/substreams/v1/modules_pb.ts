...
export const file_sf_substreams_v1_modules: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 *
 * @generated from message sf.substreams.v1.Module.FoundationalStore
 */
export type Module_FoundationalStore = Message<"sf.substreams.v1.Module.FoundationalStore"> & {
  /**
...
/**
 * Describes the message sf.substreams.v1.Module.FoundationalStore.
 * Use `create(Module_FoundationalStoreSchema)` to create a new message.
 */
export const Module_FoundationalStoreSchema: GenMessage<Module_FoundationalStore> = /*@__PURE__*/
...
export type Module_Input = Message<"sf.substreams.v1.Module.Input"> & {
  ...
  input: {
    ...
    /**
     * @generated from field: sf.substreams.v1.Module.FoundationalStore foundational_store = 5;
     */
    value: Module_FoundationalStore;
    case: "foundationalStore";
  } | { case: undefined; value?: undefined };
};
...
export const Module_Input_SourceSchema: GenMessage<Module_Input_Source> = /*@__PURE__*/
  messageDesc(file_sf_substreams_v1_modules, 2, 6, 0);
...
export const Module_Input_MapSchema: GenMessage<Module_Input_Map> = /*@__PURE__*/
  messageDesc(file_sf_substreams_v1_modules, 2, 6, 1);
...
export const Module_Input_StoreSchema: GenMessage<Module_Input_Store> = /*@__PURE__*/
  messageDesc(file_sf_substreams_v1_modules, 2, 6, 2);
...
export const Module_Input_Store_ModeSchema: GenEnum<Module_Input_Store_Mode> = /*@__PURE__*/
  enumDesc(file_sf_substreams_v1_modules, 2, 6, 2, 0);
...
export const Module_Input_ParamsSchema: GenMessage<Module_Input_Params> = /*@__PURE__*/
  messageDesc(file_sf_substreams_v1_modules, 2, 6, 3);
...
export const Module_OutputSchema: GenMessage<Module_Output> = /*@__PURE__*/
  messageDesc(file_sf_substreams_v1_modules, 2, 7);
