...
export class ProcessRangeRequest extends Message<ProcessRangeRequest> {
	...
	static equals(
		a: ProcessRangeRequest | PlainMessage<ProcessRangeRequest> | undefined,
		b: ProcessRangeRequest | PlainMessage<ProcessRangeRequest> | undefined,
	): boolean {
...
export class ProcessRangeResponse extends Message<ProcessRangeResponse> {
	...
	static equals(
		a: ProcessRangeResponse | PlainMessage<ProcessRangeResponse> | undefined,
		b: ProcessRangeResponse | PlainMessage<ProcessRangeResponse> | undefined,
	): boolean {
...
export class Update extends Message<Update> {
	...
	static equals(
		a: Update | PlainMessage<Update> | undefined,
		b: Update | PlainMessage<Update> | undefined,
	): boolean {
...
export class Completed extends Message<Completed> {
	...
	static equals(
		a: Completed | PlainMessage<Completed> | undefined,
		b: Completed | PlainMessage<Completed> | undefined,
	): boolean {
...
export class Failed extends Message<Failed> {
	...
	static equals(
		a: Failed | PlainMessage<Failed> | undefined,
		b: Failed | PlainMessage<Failed> | undefined,
	): boolean {
